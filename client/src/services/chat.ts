...
export const getChat = async (id: string, page = 1, limit = 20) => {
	try {
		const response = await Axios.get(`${API_URL}/chat/${id}?page=${page}&limit=${limit}`, getConfig());
		return response.data;
	} catch (err: any) {
		console.log('err', err);
		throw err;
...
export const updatedChat = async (id: string, payload: any) => {
	try {
		const response = await Axios.put(`${API_URL}/chat/${id}`, { ...payload }, getConfig());
		return response.data;
	} catch (err: any) {
		console.log('err', err);
		throw err;
...
export const deleteMessage = async (chatId: string, messageId: string) => {
	try {
		const response = await Axios.delete(`${API_URL}/chat/${chatId}/message/${messageId}`, getConfig());
		return response.data;
	} catch (err: any) {
		console.log('err', err);
		throw err;
...
export const readMessage = async (chatId: string, messageId: string) => {
	try {
		const response = await Axios.put(`${API_URL}/chat/${chatId}/message/${messageId}`, {}, getConfig());
		return response.data;
	} catch (err: any) {
		console.log('err', err);
		throw err;
...
export const addMembers = async (chatId: string, members: string[]) => {
	try {
		const response = await Axios.post(`${API_URL}/chat/${chatId}/members`, { members }, getConfig());
		return response.data;
	} catch (err: any) {
		console.log('err', err);
		throw err;
...
export const removeMember = async (chatId: string, memberId: string) => {
	try {
		const response = await Axios.delete(`${API_URL}/chat/${chatId}/members/${memberId}`, getConfig());
		return response.data;
	} catch (err: any) {
		console.log('err', err);
		throw err;
